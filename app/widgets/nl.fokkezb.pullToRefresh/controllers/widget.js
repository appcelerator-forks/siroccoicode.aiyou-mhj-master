...
(function constructor(args) {
  ...
  if (!_.isArray(args.children) || !_.contains(['Ti.UI.ListView', 'Ti.UI.TableView', 'de.marcelpociot.CollectionView'], args.children[args.cusvalue].apiName)) {
 ...
 var list = args.children[args.cusvalue];
